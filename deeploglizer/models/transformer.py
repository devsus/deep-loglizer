...
class Transformer(ForcastBasedModel):
    def __init__(
        ...
        **kwargs
        ...
        encoder_layer = nn.TransformerEncoderLayer(embedding_dim, nhead, hidden_size, batch_first=True) # !
    ...
    def forward(self, input_dict):
        ...
        x_transformed = self.transformer_encoder(x.float()) # !
        representation = x_transformed.mean(dim=1) # !
